...
export default class MenuExampleSizeLarge extends Component {
  ...
  render() {
    ...
    return (
      <Menu size='large' position='middle'>
      <Menu.Menu position='middle' style={{marginRight:100, marginLeft:100}}>
      <Dropdown item text='카테고리' style={{marginRight:40, marginLeft: 40}}>
          <Dropdown.Menu>
